                ...
                <table className="table-fixed divide-y w-full">
                    <thead>
                        <tr className="bg-slate-200 text-slate-500">
                            <th className="text-sm text-start font-medium py-3 px-6 w-3/12">Pengguna</th>
                            <th className="text-sm text-start font-medium py-3 px-6 w-5/12">Kalimat</th>
                            <th className="text-sm text-start font-medium py-3 px-6 w-2/12">Prediksi</th>
                            <th className="text-sm text-start font-medium py-3 px-6 w-2/12">Tanggal</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className="hover:bg-slate-100 duration-100">
                            ...
                            <td className="text-sm font-light py-3 px-6">
                                <span className="block font-semibold text-xs bg-teal-100 text-teal-500 text-center p-2 rounded-full">Tidak Radikal</span>
                            </td>
                            <td className="text-sm font-light py-3 px-6">
                                02/12/2023 24:00
                            </td>
                        ...
                        <tr className="hover:bg-slate-100 duration-100">
                            ...
                            <td className="text-sm font-light py-3 px-6">
                                <span className="block font-semibold text-xs bg-rose-100 text-rose-500 text-center p-2 rounded-full">Cenderung Radikal</span>
                            </td>
                            <td className="text-sm font-light py-3 px-6">
                                02/12/2023 24:00
                            </td>
